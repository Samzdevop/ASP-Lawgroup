    ...
    <section className="relative py-20 px-6 md:px-20 text-white bg-black">
      ...
      <div className="grid md:grid-cols-2 gap-16 relative z-10">
        ...
        <div className="space-y-4 bg-[#1a1a1a] p-6 border border-gray-800 relative">
          ...
          <h2 className="text-xl text-[#666464] text-center">
            Contact
          </h2>
          ...
          <input
            ...
            className="w-full p-3 bg-black border-b border-[#fbaf19]"
            placeholder="Name"
          />
          ...
          <button
            ...
            disabled={loading}
            className="text-black px-6 py-3 mt-4 font-medium rounded-xl disabled:opacity-50"
            style={{
              background:
